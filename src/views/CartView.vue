                ...
                <div class="d-flex gap-3 align-items-start">
                  ...
                  <div class="flex-grow-1">
                    ...
                    <div class="d-flex align-items-center gap-2 mt-2">
                      <button class="qty-btn" @click="cart.updateItem(item.id, (item.quantity || 1) - 1)" :disabled="(item.quantity || 1) <= 1">
                        <i class="bi bi-dash" style="font-size:.7rem;"></i>
                      </button>
                      <span class="text-cream px-1">{{ item.quantity || 1 }}</span>
                      <button class="qty-btn" @click="cart.updateItem(item.id, (item.quantity || 1) + 1)">
                  ...
                  <div class="text-end d-flex flex-column align-items-end gap-2">
                    ...
                    <span class="text-muted" style="font-size:.78rem;">{{ formatPrice(item.price) }} each</span>
