          ...
          <div v-for="item in cart.items" :key="item.id" class="cart-item">
            ...
            <div class="flex-grow-1 min-w-0">
              ...
              <div class="d-flex align-items-center gap-2 mt-1">
                <button class="qty-btn" @click="decreaseQty(item)" :disabled="cart.loading">
                  <i class="bi bi-dash" style="font-size:.7rem;"></i>
                </button>
                <span class="text-cream" style="font-size:.9rem; min-width:20px; text-align:center;">{{ item.quantity || 1 }}</span>
                <button class="qty-btn" @click="increaseQty(item)" :disabled="cart.loading">
